...
{name:"The Wicked Hop",address:"345 N Broadway",area:"Historic Third Ward",style:"Hand-breaded fried Wisconsin cheese curds",note:"Ranch or house-made marinara",lat:43.0348876,lng:-87.9075696,site:"https://www.thewickedhop.com/",map:"https://www.google.com/maps/search/?api=1&query=The+Wicked+Hop&query_place_id=ChIJ71JuoqYZBYgRRStD3vllXKo"},
{name:"Café Benelux",address:"346 N Broadway",area:"Historic Third Ward",style:"Hand-breaded Ellsworth white cheddar curds",note:"Yogurt buttermilk ranch or choice of sauce",lat:43.0349024,lng:-87.9069918,site:"https://cafebenelux.com/menus",map:"https://www.google.com/maps/search/?api=1&query=Caf%C3%A9+Benelux&query_place_id=ChIJZ_10J6QZBYgRjajwdJ3ukeg"},
...
function initMap(){
  ...
  const legsReady=fetch('routes.json').then(r=>r.json()).catch(()=>null);
